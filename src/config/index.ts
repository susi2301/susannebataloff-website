...
export const SITE_CONTENT: SiteContent = {
  ...
  about: {
    description: `
      Hi! My name is Dani, I'm a <span class="text-primary font-bold">Game Developer<span class="text-primary font-bold"> and <span class="text-primary font-bold">Game Designer<span class="text-primary font-bold"> as well as the founder of <span class="text-primary font-bold">Thirteen Games<span class="text-primary font-bold">, an independent game studio established in 2026. Game development has been my passion for years, and even while working in other fields, I always spent my free time creating and developing games.
